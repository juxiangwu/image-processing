...
{
    Mat h_image;
    h_image = imread("../../../../datas/face.jpg", 0);
    Ptr<cuda::CascadeClassifier> cascade = cuda::CascadeClassifier::create("../../../../datas/cvdata/haarcascades_cuda/haarcascade_frontalface_alt2.xml");
    cuda::GpuMat d_image;
    cuda::GpuMat d_buf;
