...
using namespace std;
#define WINDOW_NAME	"CUDA createCannyEdgeDetector"
...
void wait_for_a_while(uv_idle_t* handle){
    ...
    cvui::text(frame, 20, 40, "low thresh");
    cvui::trackbar(frame, 20, 60, 180, &low_thresh, (int)0, (int)255);
    cvui::text(frame,20,140,"high thresh");
    cvui::trackbar(frame, 20, 160, 180, &high_thresh, (int)0, (int)255);
    if (cvui::button(frame, 20, 230,180,30, "createCannyEdgeDetector")) {
//        cv::Mat gray;
...
//            gray.convertTo(gray,CV_32F);
            ...
            detector->detect(dev_gray,dev_res);
