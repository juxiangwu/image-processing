...
using namespace std;
#define WINDOW_NAME	"CUDA createMorphologyFilter"
...
void wait_for_a_while(uv_idle_t* handle){
    ...
    cvui::text(frame, 10, 40, "Type:MORPH_ERODE");
    cvui::trackbar(frame, 20, 90, 180, &ksize, (int)1, (int)7);
    ...
    case 1:
        ...
        break;
    case 2:
        cvui::text(frame, 10, 40, "Type:MORPH_DILATE");
        break;
    case 3:
        cvui::text(frame, 10, 40, "Type:MORPH_OPEN");
        break;
    case 4:
        cvui::text(frame, 10, 40, "Type:MORPH_CLOSE");
        break;
    case 5:
        cvui::text(frame, 10, 40, "Type:MORPH_GRADIENT");
        break;
    case 6:
        cvui::text(frame, 10, 40, "Type:MORPH_TOPHAT");
        break;
    case 7:
        cvui::text(frame, 10, 40, "Type:MORPH_BLACKHAT");
        break;
    default:
        break;
    }

    if (cvui::button(frame, 20, 160,180,30, "createMorphologyFilter")) {
        cv::Mat gray;
        ...
        switch (ksize) {
        case 1:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_ERODE,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_ERODE");
            break;
        case 2:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_DILATE,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_DILATE");
            break;
        case 3:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_OPEN,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_OPEN");
            break;
        case 4:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_CLOSE,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_CLOSE");
            break;
        case 5:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_GRADIENT,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_GRADIENT");
            break;
        case 6:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_TOPHAT,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_TOPHAT");
            break;
        case 7:
            filter =cv::cuda::createMorphologyFilter(cv::MORPH_BLACKHAT,gray.type(),kernel);
            cvui::text(frame, 10, 40, "Type:MORPH_BLACKHAT");
            break;
        default:
            break;
