...
using namespace std;
#define WINDOW_NAME	"CUDA createConvolution"
...
//    src2_rz.copyTo(roi2);
    ...
    if (cvui::button(frame, 15, 50,100,30, "createConvolution")) {
        cv::Ptr<cv::cuda::Convolution> conv = cv::cuda::createConvolution(cv::Size(3,3));
