...
__kernel void prewitt_2_filter(__read_only image2d_t input,
                               __write_only image2d_t output){
     const sampler_t sampler = CLK_FILTER_NEAREST |
                               CLK_NORMALIZED_COORDS_FALSE |
                               CLK_ADDRESS_CLAMP_TO_EDGE;
     
     float color_mask [8 * 9] = {
         1.0f,1.0f,1.0f,1.0f,-2.0f,1.0f,-1.0f,-1.0f,-1.0f,
         1.0f,1.0f,1.0f,1.0f,-2.0f,-1.0f,1.0f,-1.0f,-1.0f,
          1.0f,1.0f,-1.0f,1.0f,-2.0f,-1.0f,1.0f,1.0f,-1.0f,
           1.0f,-1.0f,-1.0f,1.0f,-2.0f,-1.0f,1.0f,1.0f,1.0f,
            -1.0f,-1.0f,-1.0f,1.0f,-2.0f,1.0f,1.0f,1.0f,1.0f,
     ...
     filter2d_internal(input,output,8,9,color_mask,1);
