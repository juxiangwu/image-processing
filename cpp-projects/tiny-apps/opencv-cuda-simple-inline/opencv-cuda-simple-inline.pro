...
win32: LIBS += -L'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.1/lib/x64/' \
-lcublas \
-lcublas_device \
-lcuda \
-lcudadevrt \
...
INCLUDEPATH += 'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.1/include'
DEPENDPATH += 'C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v9.1/include'

#win32: LIBS += -L$$PWD/../../../../../../temp/opencv/build/install/x64/vc14/lib/ -lopencv_aruco400
