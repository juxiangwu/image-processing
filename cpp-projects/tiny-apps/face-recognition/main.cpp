...
int main(int argc, char** argv) try
{
    ...
    shape_predictor sp;
    deserialize("D:/Develop/DL/projects/resources/models/dlib/shape_predictor_68_face_landmarks.dat") >> sp;
    // And finally we load the DNN responsible for face recognition.
    anet_type net;
    deserialize("D:/Develop/DL/projects/resources/models/dlib/dlib_face_recognition_resnet_model_v1.dat") >> net;
...
//    cropper.set_min_object_height(0.97);
    cropper.set_min_object_size(0,0);
