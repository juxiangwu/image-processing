...
int main(int argc,char** argv)
{
    ...
    //CascadeClassifier faceDetector("../../datas/cvdata/haarcascade/haarcascade_frontalface_alt2.xml");
    // [2]LBP Face Detector
    CascadeClassifier faceDetector("../../datas/cvdata/haarcascade/lbpcascade_frontalface.xml");

    // 创建Facemark类的对象
    Ptr<Facemark> facemark = FacemarkLBF::create();

    // 加载人脸检测器模型
    facemark->loadModel("../../../../resources/models/opencv/lbfmodel.yaml");
    cv::Mat frame = cv::imread("../../../datas/face2.jpg");
