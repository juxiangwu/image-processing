...
int main()
{
    try
    {
        ...
        FaceDetectorAndTracker detector("d:/Develop/DL/libs/opencv-3.4.3-cu91-vs2015-x64/etc/haarcascades/haarcascade_frontalface_default.xml", 0, num_faces);
        FaceSwapper face_swapper("D:/Develop/DL/projects/resources/models/dlib/shape_predictor_68_face_landmarks.dat");
