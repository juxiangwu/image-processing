...
def main():
    ...
    triangleShader = ShaderProgram([virus], '../../datas/glsl/simpleMVP.vert', '../../datas/glsl/simpleMVP.frag')
    normalShader = ShaderProgram([normVirus], '../../datas/glsl/normalViz.vert', '../../datas/glsl/normalViz.frag')
