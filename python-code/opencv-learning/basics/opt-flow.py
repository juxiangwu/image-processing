...
def calculateFrameStats(sourcePath, verbose=False, after_frame=0):  # 提取相邻帧的差别
    cap = cv2.VideoCapture('../resources/videos/key-frame-video.mp4')#提取视频
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s','--source', help='source file', default="../resources/videos/key-frame-video.mp4")
