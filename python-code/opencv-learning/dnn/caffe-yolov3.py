...
def rects_prepare(output, inp_dim=416, num_classes=80):
    ...
    for key, value in output.items():
        ...
        if prediction is None:
            prediction = predict_transform(value, anchors=[(116, 90), (156, 198), (373, 326)] )
        else:
            prediction = np.concatenate([prediction, predict_transform(value, anchors=[(116, 90), (156, 198), (373, 326)] )], axis=1)
...
def parse_args():
    ...
    parser.add_argument('--prototxt', type=str, default='../resources/models/caffe/yolov3/yolov3.prototxt')
    parser.add_argument('--caffemodel', type=str, default='../resources/models/caffe/yolov3/yolov3.caffemodel')
    parser.add_argument('--classfile', type=str, default='../resources/models/caffe/yolov3/coco.names')
    parser.add_argument('--image', type=str, default='../resources/images/person-dog-horse.jpg')
