...
openface.helper.mkdirP('temp/aligned-images/') #'/aligned-images/ --> Out Directory for storing aligned images

# Model used to predict the 68 face landmarks
dlibFacePredictor = '../resources/models/dlib/shape_predictor_68_face_landmarks.dat'

#Defining an object of AlignDlib class
align = openface.AlignDlib(dlibFacePredictor)

#Iterating among all the images
imgs = list(iterImgs('temp/training-images'))
...
for imgObject in imgs :
    ...
    outDir = os.path.join('temp/aligned-images/',imgObject.cls)
