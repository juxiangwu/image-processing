...
def main():
    ...
    model = eos.morphablemodel.load_model("D:/Develop/opensources/eos/share/sfm_shape_3448.bin")
    blendshapes = eos.morphablemodel.load_blendshapes("D:/Develop/opensources/eos/share/expression_blendshapes_3448.bin")
    ...
    landmark_mapper = eos.core.LandmarkMapper('D:/Develop/opensources/eos/share/ibug_to_sfm.txt')
    edge_topology = eos.morphablemodel.load_edge_topology('D:/Develop/opensources/eos/share/sfm_3448_edge_topology.json')
    contour_landmarks = eos.fitting.ContourLandmarks.load('D:/Develop/opensources/eos/share/ibug_to_sfm.txt')
    model_contour = eos.fitting.ModelContour.load('D:/Develop/opensources/eos/share/sfm_model_contours.json')
