#coding:utf-8
import utils.mtcnn_tools_matrix as tools
import caffe
import cv2
import numpy as np
deploy = '../resources/models/caffe/mtcnn-face/12net.prototxt'
caffemodel = '../resources/models/caffe/mtcnn-face/12net.caffemodel'
net_12 = caffe.Net(deploy,caffemodel,caffe.TEST)

deploy = '../resources/models/caffe/mtcnn-face/24net.prototxt'
caffemodel = '../resources/models/caffe/mtcnn-face/24net.caffemodel'
net_24 = caffe.Net(deploy,caffemodel,caffe.TEST)

deploy = '../resources/models/caffe/mtcnn-face/48net.prototxt'
caffemodel = '../resources/models/caffe/mtcnn-face/48net.caffemodel'
...
imgpath = "../resources/images/person-dog.jpg"
...
cv2.waitKey()
cv2.imwrite('temp/test.jpg',draw)