...
def parse_args():
    ...
    parser.add_argument('--proto', dest='proto',
                        help="path to deploy prototxt.", type=str,default="../resources/models/caffe/mobilenet/mobilenet_v2_deploy.prototxt")
    parser.add_argument('--model', dest='model',
                        help='path to pretrained weights', type=str,default="../resources/models/caffe/mobilenet/mobilenet_v2.caffemodel")
    parser.add_argument('--image', dest='image',
                        help='path to color image', type=str,default="../resources/images/dog-cycle-car.png")
...
def eval():
    ...
    label_names = np.loadtxt('../resources/models/caffe/mobilenet/synset.txt', str, delimiter='\t')
    for i in range(5):
        label = idx[i]
