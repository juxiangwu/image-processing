...
net_work_path = '../resources/models/caffe/face-landmark/landmark_deploy.prototxt'
weight_path = '../resources/models/caffe/face-landmark/VanFace.caffemodel'
images_dir = '/home/code/face-landmark/images/'
result_dir = 'temp'

image_list = ['datas/obama.jpg']#file_list_fn(images_dir)
caffe.set_mode_gpu()
