...
def parse_args():
    ...
    parser.add_argument('--proto', dest='proto',
                        help="path to deploy prototxt.", type=str,default="../resources/models/caffe/mobilenet/mobilenet_deploy.prototxt")
    parser.add_argument('--model', dest='model',
                        help='path to pretrained weights', type=str,default="../resources/models/caffe/mobilenet/mobilenet.caffemodel")
